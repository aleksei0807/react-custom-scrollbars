...
exports.default = (0, _react.createClass)({
    ...
    _update: function _update(callback) {
        ...
        if ((0, _getScrollbarWidth2.default)() && (!this.props.disableAutoScrollOnTrack || this.props.disableAutoScrollOnTrack && this.thumbHeight === null && !this.dontMoveThumb)) {
            console.log('update', 'getScrollbarWidth()', (0, _getScrollbarWidth2.default)(), 'this.props.disableAutoScrollOnTrack', this.props.disableAutoScrollOnTrack, 'this.thumbHeight', this.thumbHeight, 'this.dontMoveThumb', this.dontMoveThumb);
