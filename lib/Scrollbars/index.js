...
exports.default = (0, _react.createClass)({
    ...
    _update: function _update(callback) {
        ...
        if ((0, _getScrollbarWidth2.default)() && (!this.props.disableAutoScrollOnTrack || this.props.disableAutoScrollOnTrack && this.thumbHeight === null)) {
    ...
    render: function render() {
        ...
        var _props5 = this.props,
            ...
            props = _objectWithoutProperties(_props5, ['onScroll', 'onScrollFrame', 'onScrollStart', 'onScrollStop', 'onUpdate', 'renderView', 'renderTrackHorizontal', 'renderTrackVertical', 'renderThumbHorizontal', 'renderThumbVertical', 'tagName', 'hideTracksWhenNotNeeded', 'autoHide', 'autoHideTimeout', 'autoHideDuration', 'thumbSize', 'thumbMinSize', 'universal', 'autoHeight', 'autoHeightMin', 'autoHeightMax', 'style', 'children', 'scrollHeight', 'clientHeight', 'disableAutoScrollOnTrack', 'scrollTopMod']);
