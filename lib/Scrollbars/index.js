...
exports.default = (0, _react.createClass)({
    ...
    _update: function _update(callback) {
        ...
        if ((0, _getScrollbarWidth2.default)() && (!this.props.disableAutoScrollOnTrack || this.props.disableAutoScrollOnTrack && this.thumbHeight === null || this.props.disableAutoScrollOnTrack && !this.dontMoveThumb)) {
